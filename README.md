...
- [ILB With Apache Server via Vnet Peering](https://github.com/adtork/ILB-with-Apache-Server) -Client over Vnet peering to an ILB with two Apache Servers in the BE. NatGW provided soley for deployment of Apache Server
