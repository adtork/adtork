...
- [Network Desk](https://github.com/dmauser/network-desk) — Copilot CLI extension: an Azure networking AI team of specialist agents for topology, security, DNS, hybrid connectivity, load balancing, and more
